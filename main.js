...
function draw() {
  ...
  let tr = rotateVector(sensor.a, sensor.b, sensor.g)
  let matAS1 = m4.multiply(matAccum1, m4.translation(tr[0] * 2.2, tr[1] * 2.2, tr[2] * 2.2))
  gl.uniformMatrix4fv(shProgram.iModelViewMatrix, false, matAS1);
  sphere.DrawSphere();
  if (panner) {
...
let source, filterNode;

function prehandAudion() {
  checkBox = document.getElementById('chckbx');
  ...
  audio.addEventListener('play', () => {
    if (!context) {
      ...
      filterNode.frequency.value = 2150;
